import Popup from 'https://cdn.jsdelivr.net/gh/tutosrive/legendary-guacamole@main/javascript/from-prog2/v1/popup.js';
import { fetchText } from './helpers/helpers.mjs';
import Toast from 'https://cdn.jsdelivr.net/gh/tutosrive/legendary-guacamole@main/javascript/from-prog2/v2/toast-v2.js';
...
export default class UserController {
  ...
  constructor(mode = 'add', data_user = {}) {
    this.#mode = mode;
