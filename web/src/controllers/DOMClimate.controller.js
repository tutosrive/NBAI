export default class DOMClimate {
  ...
  load_climate_map() {
    ...
    const html_icon_weather = () => {
      ...
      return `<div class="p-0 position-fixed"><img class="shadow-img just-icon-weather" src="${this.#icon_weather}" alt="Icon weather, ${this.#climate.weather[0].description}"></div>`;
    };
